...
Interpolando i valori degli ordini dei segmenti, con la loro numerosità e con il parametro ricavato dalla prima legge di Horton, si ottiene un grafico caratteristico \eqref{figure:legge_horton}.
\begin{figure}[H]\centering
    \includegraphics[scale=.75]{immagini/legge_horton.png}
    \caption{Relazione tra l'ordine del tratto, la sua numerosità e la funzione di Horton (secondo la CTP).}
    \label{figure:legge_horton}
\end{figure}
...
Interpolando i valori degli ordini dei segmenti, con la loro numerosità e con il parametro ricavato dalla prima legge di Horton, si ottiene un grafico caratteristico \eqref{figure:legge_horton_qgis}.
\begin{figure}[H]\centering
    \includegraphics[scale=.75]{immagini/legge_horton_qgis.png}
    \caption{Relazione tra l'ordine del tratto, la sua numerosità e la funzione di Horton (secondo il DTM).}
    \label{figure:legge_horton_qgis}
\end{figure}
...
I calcoli, svolti in un foglio di calcolo elettronico, sono riportati nella tabella \eqref{table:valori_caratt_altimetria}.

\begin{table}[H]
    \caption{\textcolor{red}{Valori caratteristici del bacino idrografico, suddivisi per fascia altimetrica.}}
   ...
   \midrule
    ...
    \bottomrule
\end{tabular}
\label{table:valori_caratt_altimetria}
    \end{table}
Dove:
\begin{itemize}
...
Osservando l'andamento della curva che lega l'area del bacino e la quota ortometrica (siano queste dimensionali o adimensionali), è possibile capire se l'ara studiata è in una condizione giovanile (dove prevale l'erosione), maturità (equilibrio) o senilità \eqref{figure:curva_ipsometrica_dimensionale}\eqref{figure:curva_ipsometrica_adimensionale}.
\begin{figure}[H] \centering
...
\label{figure:curva_ipsometrica_dimensionale}
\end{figure}    
...
\label{figure:curva_ipsometrica_adimensionale}
\end{figure}
...
Conoscendo la pendenza di ogni singola fascia di quota, è possibile raffigurare in un grafico \eqref{figure:distr_pendenza_bacino} la pendenza media di ogni sezione di bacino, avente quote altimetriche simili.
\begin{figure}[H] \centering
\includegraphics[scale=0.8]{immagini/istogramma_distribuzione_pendenze.png}
    ...
    \label{figure:distr_pendenza_bacino}
\end{figure}

\subsection{Distribuzione delle aree del bacino}
Il grafico \eqref{figure:distr_aree_bacino} indica come l'area del bacino idrografico venga suddivisa in base alla fascia altimetrica.
\begin{figure}[H] \centering
...
\label{figure:distr_aree_bacino}
\end{figure}
...
\label{figure:coll_princ}
\end{figure}

Il grafico \eqref{figure:coll_princ} è stato ricavato mediante l'utilizzo di un foglio elettronico di calcolo, utilizzando i dati provenienti da Qgis.\\
...
Successivamente ad aver analizzato in modo completo il bacino idrografico, è possibile redigere una tabella riassuntiva \eqref{table:valori_globali}.
\begin{table}[H] \centering
