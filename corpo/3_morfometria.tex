...
Nel caso del reticolo idrografico della CTP preso da noi in esame, i parametri sono: 
...
\end{tabular}
\end{table}
\noindent Il rapporto di biforcazione medio $\bar{R}_b$, secondo il ragionamento svolta sulla CTP è pari a \num{2.3}.\\
...
\begin{table}[H] \centering
    ...
    Quota massima & $h_{max}$&  $\left[m s.m.\right]$       &    2085      \\
